        ...
        'sp': {
            ...
            'idp': {
                ...
                'https://idp2.example.com/simplesaml/saml2/idp/metadata.php': {
                    'single_sign_on_service': {
                        saml2.BINDING_HTTP_REDIRECT: 'https://idp2.example.com/simplesaml/saml2/idp/SSOService.php',
                    },
                    'single_logout_service': {
                        saml2.BINDING_HTTP_REDIRECT: 'https://idp2.example.com/simplesaml/saml2/idp/SingleLogoutService.php',
                    },
                },
            },
        },
